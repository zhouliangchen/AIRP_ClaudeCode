...
class ImportPrepareTest(unittest.TestCase):
    ...
    def test_run_import_creates_missing_blank_card_folder(self):
        ...
        self.assertFalse((card_dir / "memory" / "characters" / "player" / "state.json").exists())
        self.assertFalse((card_dir / "memory" / "characters" / "player" / "goals.md").exists())
        self.assertFalse((card_dir / "memory" / "characters" / "player" / "goals.json").exists())

...
class ControlPlaneSmokeTest(unittest.TestCase):
    def test_control_plane_smoke_reports_delivery_evidence(self):
        ...
        self.assertTrue(payload["structured_memory"]["character:Ada"])
        ...
        self.assertEqual(payload["trace"]["private_event_count"], 0)
        self.assertEqual(len(payload["trace"]["visible_events"]), 3)
        ...
        self.assertIn("character:Ada", payload["post_round_memory"]["ingested"])
        ...
        self.assertIn("style_profile", payload["quality_metrics"])

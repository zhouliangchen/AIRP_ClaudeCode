...
- If you update save-level UI schema in `ui_manifest.json`, update `postprocess_contract.json` at the same time so the postprocess runtime prompt contract knows which `ui_extensions` data to provide.
